...
import com.example.sub2movieandtv.MovieDetail;
...
public class ListMovieAdapter extends RecyclerView.Adapter<ListMovieAdapter.ListMovieViewHolder> {
    ...
    public ListMovieAdapter (Context context){this.context=context;}
    ...
    public void onBindViewHolder(@NonNull ListMovieViewHolder listMovieViewHolder, int position) {
        ...
        listMovieViewHolder.tvDateReleased.setText(movie.getYear_in());
        listMovieViewHolder.tvUserScore.setText(movie.getUser_score());
        listMovieViewHolder.tvRuntime.setText(movie.getRuntime());
